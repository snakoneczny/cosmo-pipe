...
if [ $run_DR1_cls = true ] ; then
    ...
    addqueue -c cls_DR1_all_radiocat -n 1x24 -s -q cmb -m 2 /usr/bin/python3 -m lotss_corr.clcalc params/params_dr1_good_radiocat.yml
    echo "Cls, DR1, all pointings, VAC"
    addqueue -c cls_DR1_all_radiocat -n 1x24 -s -q cmb -m 2 /usr/bin/python3 -m lotss_corr.clcalc params/params_dr1_all_VAC.yml
    echo "Cls, DR1, good pointings, VAC"
    addqueue -c cls_DR1_all_radiocat -n 1x24 -s -q cmb -m 2 /usr/bin/python3 -m lotss_corr.clcalc params/params_dr1_good_VAC.yml
    echo "Cls, DR1, all pointings, radio catalog, p from cat"
    addqueue -c cls_DR1_all_radiocat -n 1x24 -s -q cmb -m 2 /usr/bin/python3 -m lotss_corr.clcalc params/params_dr1_all_radiocat_pcat.yml
    echo " "
fi
...
if [ $run_DR2_cls = true ] ; then
    echo "Cls, DR2"
    addqueue -c cls_DR1_all_radiocat -n 1x24 -s -q cmb -m 2 /usr/bin/python3 -m lotss_corr.clcalc params/params_dr2.yml
    echo "Cls, DR2, p from catalog"
    addqueue -c cls_DR1_all_radiocat -n 1x24 -s -q cmb -m 2 /usr/bin/python3 -m lotss_corr.clcalc params/params_dr2_pcat.yml
    echo " "
fi
